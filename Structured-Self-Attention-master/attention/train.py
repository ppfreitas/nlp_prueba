...
def train(attention_model,train_loader,criterion,optimizer,epochs = 5,use_regularization = False,C=0,clip=False):
    ...
    for i in range(epochs):
        ...
        print("Accuracy of the model",torch.true_divide(correct,(n_batches*train_loader.batch_size)))
        losses.append(total_loss/n_batches)
        accuracy.append(torch.true_divide(correct,(n_batches*train_loader.batch_size)))
